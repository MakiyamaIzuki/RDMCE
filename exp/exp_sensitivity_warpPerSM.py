...
def main():
    ...
    TARGET_METHOD = '20'  # 用户可修改此处为目标方法名
    ...
    # 定义颜色列表
    colors = ['lightcoral', 'linen', 'bisque', 'lavender', 'aliceblue', 'gainsboro', '#D2B48C', 'mistyrose', 'mintcream', 'oldlace']
    ...
    for i, method in enumerate(METHODS):
        if method in df.columns:
            ...
            plt.bar(x_values, y_values, width=width, label=f'warpPerSM={method}', color=color, edgecolor='black')
    ...
    plt.legend(fontsize=10.5, ncol=2)
    plt.tight_layout()
